export default class ServerInteractor {
    ...
    onMessage(event) {
        ...
        switch(message.action) {
            case "create": this.app.creator.create(message); break;
            case "destroy": this.app.destroyer.destroy(message); break;
            case "update": this.app.updater.update(message); break;
            case "invoke": this.app.invoker.invoke(message); break;
            case "import": this.app.importer.import(message); break;
            default:
